...
def preprocessing_for_artm(number_of_docs_as_collection_length=False, number_of_docs=10):
    ...
    for i in range(number_of_docs):
        ...
        all_docs += "\n"
    f = open("/Users/ruslantagirov/Desktop/Univer/3course/data-repo/LabWorks/labs/LW5/data_for_artm/lenta_artm.txt",
             "w")
    f.write(all_docs)
    f.close()
...
def run():
    ...
    batch_vectorizer = artm.BatchVectorizer(
        data_path="/Users/ruslantagirov/Desktop/Univer/3course/data-repo/LabWorks/labs/LW5/data_for_artm/lenta_artm.txt",
